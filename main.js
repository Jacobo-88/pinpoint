var game= function(){
  ...
  function init(){
    ...
    player1.keyCode =null; // Q y la A player1
    player2.keyPress = false;
    player2.keyCode =null;  // O y la L player2 
  ...
  function checkStateBall(){
    ...
    if(ball.direction ===1){
      if(ball.offsetTop >= height) ball.style=2;
      else if(ball.offsetTop <= 0 ) ball.style=1;
    }else{
      if(ball.offsetTop >= height) ball.style=4;
      else if(ball.offsetTop <= 0 ) ball.style=3;
    }
  }
  ...
  function collidePlayer1(){
    if(ball.offsetLeft <= (bar1.clientWidth) &&
      ...
      ball.offsetTop <= (bar1.offsetTop + bar1. clientWidth)){
      return true;
    }
    return false;
  }
  ...
  function collidePlayer2(){
    if(ball.offsetLeft >= (width-bar2.clientWidth) &&
      ...
      ball.offsetTop <= (bar2.offsetTop + bar2. clientWidth)){
      return true;
    }
    return false;
  }
